...
#### Edit CertManager cluster spec for dns
...
spec:  
  unsupportedConfigOverrides:
    controller:
      args:
        - '--dns01-recursive-nameservers=[2606:4700:4700::1111]:53,[2606:4700:4700::1001]:53,1.1.1.1:53,1.0.0.1:53'
...
```bash
oc apply -f letsencrypt-cluster-issuer.yaml
```
...
### Update the default IngressController to use the LetsEncrypt wildcard certificate
...
### Update the API server to use the LetsEncrypt API certificate
